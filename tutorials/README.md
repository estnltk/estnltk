...
* System taggers and tools for rule-based language engineering:
    ...
    * [rule_taggers](taggers/rule_taggers) -- Rule based taggers for text annotation using regular experssions, word listings, phrase patterns, dependency syntactic relations and morphosyntactic features; systematic development and testing of regular expression patterns; 
