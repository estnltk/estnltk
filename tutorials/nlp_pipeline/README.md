...
* [B_morphology](B_morphology/) tutorials describe morphological analysis tools (Vabamorf, text-based and corpus-based disambiguator, user dictionary tagger, UD and GT converters; HFST-based analyser; Bert-based morphological tagger, GliLem lemmatizer/disambiguator, Vabamorf with Bert-based disambiguator, Bert-based morphological form homonymy post-corrector), morphological synthesis, spelling correction, stemming, compound word detection and syllabification.
