...
def test_touching_positions():
    ...
    # Test on Spans
    span1 = Span(base_span=ElementaryBaseSpan(start= 0, end= 3))  # üks
    span2 = Span(base_span=ElementaryBaseSpan(start= 4, end= 8))  # kaks
    span3 = Span(base_span=ElementaryBaseSpan(start= 9, end=13))  # kolm
    span4 = Span(base_span=ElementaryBaseSpan(start=13, end=17))  # neli
    span5 = Span(base_span=ElementaryBaseSpan(start=18, end=22))  # viis
    span6 = Span(base_span=ElementaryBaseSpan(start=22, end=26))  # kuus
    span7 = Span(base_span=ElementaryBaseSpan(start=27, end=33))  # seitse
...
def test_nested_positions():
    ...
    span3  = Span(base_span=ElementaryBaseSpan(start= 9, end=13))   # kolm
    span4  = Span(base_span=ElementaryBaseSpan(start=13, end=17))  # neli
    span34 = Span(base_span=ElementaryBaseSpan(start= 9, end=17))   # kolmneli
    span5  = Span(base_span=ElementaryBaseSpan(start=18, end=22))  # viis
    span6  = Span(base_span=ElementaryBaseSpan(start=22, end=26))  # kuus
    span56 = Span(base_span=ElementaryBaseSpan(start=18, end=26))  # viiskuus
    span7  = Span(base_span=ElementaryBaseSpan(start=27, end=33))  # seitse
...
def test_overlapping_positions():
    ...
    span2  = Span(base_span=ElementaryBaseSpan(start=4,  end=8))    # kaks
    span3  = Span(base_span=ElementaryBaseSpan(start=9,  end=13))   # kolm
    span23 = Span(base_span=ElementaryBaseSpan(start=4,  end=13))   # 'kaks kolm'
    span4  = Span(base_span=ElementaryBaseSpan(start=13, end=17))  # neli
    span34 = Span(base_span=ElementaryBaseSpan(start=9,  end=17))   # kolmneli
    span5  = Span(base_span=ElementaryBaseSpan(start=18, end=22))  # viis
    span6  = Span(base_span=ElementaryBaseSpan(start=22, end=26))  # kuus
    span56 = Span(base_span=ElementaryBaseSpan(start=18, end=26))  # viiskuus
    span7  = Span(base_span=ElementaryBaseSpan(start=27, end=33))  # seitse
    span67 = Span(base_span=ElementaryBaseSpan(start=22, end=33))  # 'kuus seitse'
...
def test_equal_positions():
    ...
    span4  = Span(base_span=ElementaryBaseSpan(start=13, end=17))  # neli
    span34 = Span(base_span=ElementaryBaseSpan(start=9, end=17))   # kolmneli
    span43 = Span(base_span=ElementaryBaseSpan(end=17, start=9))   # kolmneli
    span5  = Span(base_span=ElementaryBaseSpan(start=18, end=22))  # viis
    span6  = Span(base_span=ElementaryBaseSpan(start=22, end=26))  # kuus
    span56 = Span(base_span=ElementaryBaseSpan(start=18, end=26))  # viiskuus
    span7  = Span(base_span=ElementaryBaseSpan(start=27, end=33))  # seitse
