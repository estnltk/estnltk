...
def test_iterators_on_enveloping_ambiguous_diff_layer():
    ...
    assert diff_layer.to_dict() == {
        ...
        'spans': {((0, 4), (5, 9)): [{'input_layer_name': 'layer_a',
                                      ...
                                      'attr_5': 'SADA KAKS',
                                      'span_status': 'missing'}],
                  ((0, 4), (5, 16)): [{'input_layer_name': 'layer_b',
                                       'attr': 'L5-1-1',
                                       'attr_5': 'SADA KAKS',
                                       'span_status': 'extra'},
                                      {'input_layer_name': 'layer_b',
                                      ...
                                      {'input_layer_name': 'layer_b',
                                       ...
                                       'span_status': 'extra'}],
                  ((0, 4), (5, 16), (17, 21)): [{'input_layer_name': 'layer_a',
                                                 'attr': 'L5-2-4',
                                                 'attr_5': 'SADA KAKSKÜMMEND KOLM',
                                                 'span_status': 'missing'}],
                  ((23, 27), (28, 33)): [{'input_layer_name': 'layer_a',
                                          'attr': 'L5-3-5',
                                          'attr_5': 'NELI TUHAT',
                                          'span_status': 'missing'}],
                  ((28, 33), (34, 38)): [{'input_layer_name': 'layer_b',
                                          'attr': 'L5-4-6',
                                          'attr_5': 'TUHAT VIIS',
                                          'span_status': 'extra'}],
                  ((34, 38),): [{'input_layer_name': 'layer_a',
                                 'attr': 'L5-5-7',
                                 'attr_5': 'VIIS',
                                 'span_status': 'missing'}],
                  ((34, 42), (43, 54)): [{'input_layer_name': 'layer_a',
                                          'attr': 'L5-6-8',
                                          'attr_5': 'VIISSADA KUUS',
                                          'span_status': 'modified'},
                                         {'input_layer_name': 'layer_a',
                                          'attr': 'L5-6-9',
                                          'attr_5': 'VIISSADA KÜMME',
                                          'span_status': 'modified'}],
                  ((55, 61), (62, 66), (67, 74)): [{'input_layer_name': 'layer_a',
                                                    'attr': 'L5-8-12',
