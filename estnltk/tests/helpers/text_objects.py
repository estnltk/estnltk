...
def empty_text_with_no_layers():
    text = Text('')
    text.meta['description'] = 'empty text, no layers'
    return text


def empty_text_with_all_layer_types():
    text = Text('')
    text.meta['description'] = 'empty text with empty layers'
...
def sentence_with_no_laywers():
    text = Text('Tere, maailm!')
    text.meta['description'] = 'brief demo text, no layers'
    return text


def sentence_with_all_layer_types():
    text = Text('Tere, maailm!')
    text.meta['description'] = 'brief demo text with layers'
...
def paragraph_with_no_layers():
    ...
    text.meta['description'] = 'short text, no layers'
    return text
    

def paragraph_with_all_layer_types():
    text = Text('Sada kakskümmend kolm. Neli tuhat viissada kuuskümmend seitse koma kaheksa. Üheksakümmend tuhat.')
    text.meta['description'] = 'short text with layers'
