...
def test_postanalysis_fix_names_with_initials():
    ...
    # Initialize tagger
    morf_tagger = VabamorfTaggerOld(postanalysis_tagger=PostMorphAnalysisTaggerOld(fix_names_with_initials=True))
    # Case 1
...
def test_postanalysis_fix_emoticons():
    ...
    # Initialize tagger
    morf_tagger = VabamorfTaggerOld(postanalysis_tagger=PostMorphAnalysisTaggerOld(fix_emoticons=True))
    # Case 1
...
def test_postanalysis_fix_www_addresses():
    ...
    # Initialize tagger
    morf_tagger = VabamorfTaggerOld(postanalysis_tagger=PostMorphAnalysisTaggerOld(fix_www_addresses=True))
    # Case 1
...
def test_postanalysis_fix_email_addresses():
    ...
    # Initialize tagger
    morf_tagger = VabamorfTaggerOld(postanalysis_tagger=PostMorphAnalysisTaggerOld(fix_email_addresses=True))
    # Case 1
...
def test_postanalysis_fix_abbreviations():
    ...
    # Initialize tagger
    morf_tagger = VabamorfTaggerOld(postanalysis_tagger=PostMorphAnalysisTaggerOld(fix_abbreviations=True))
    # Case 1
...
def test_postanalysis_fix_numeric():
    ...
    # Initialize tagger
    morf_tagger = VabamorfTaggerOld(postanalysis_tagger=PostMorphAnalysisTaggerOld(fix_numeric=True))
    # Case 1 : percentages
...
def test_postanalysis_with_correction_rewriter_for_numbers():
    ...
    # Initialize taggers
    postanalysis_tagger = \
        PostMorphAnalysisTaggerOld(correction_rewriter = VabamorfCorrectionRewriter())
    morf_tagger = \
        VabamorfTaggerOld(postanalysis_tagger=postanalysis_tagger)
    # Case 1
