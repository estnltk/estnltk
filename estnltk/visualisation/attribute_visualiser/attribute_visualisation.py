from IPython.display import display_html, display_javascript, HTML
...
class DisplayAttributes:
    ...
    def __init__(self, name=""):
        ...
        self.name = name
        display_html(self.general_js(), raw=True)
    ...
    def html_output(self, layer):
        ...
        outputs = [self.css(), self.event_handler_code()]
    ...
    def general_js(self):
        with open(self.general_js_file) as f:
            contents = f.read()
        return ''.join(["<script>",contents,"</script>"])
