...
'exsess' : [ 'liialt', 'liiga', 'liigselt', 'ülearu', 'üleliia', 'ülemäära', 'häirivalt', 'karjuvalt', 'kohatult', 'piinavalt', 'röögatult', 'talumatult', 'tapvalt', 'tobedalt', 'totralt', 'tüütult', 'väljakannatamatult', 'vastikult', 'jaburalt', 'piinlikult', 'ületamatult', 'võimatult']}
