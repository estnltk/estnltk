...
from estnltk.taggers.text_segmentation.np_chunker_v1_4_1 import NounPhraseChunkerV1_4
# Constants
from estnltk.taggers.text_segmentation.np_chunker_v1_4_1 import PARSER_OUT, SENT_ID
