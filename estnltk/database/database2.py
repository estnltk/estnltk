...
def create_index(index_name, **kwargs):
    ...
    **kwargs
    ...
    """
    mapping = {'mappings': {'document': {'_all': {'enabled': False},
                                         'properties': {'meta': {'type': 'object'}}},
                            'flag': {'_all': {'enabled': False},
                                     '_parent': {'type': 'sentence'},
                                     'properties': {'value': {'doc_values': True,
                                                              'index': 'not_analyzed',
                                                              'norms': {'enabled': False},
                                                              'type': 'string'}}},
                            'sentence': {'_all': {'enabled': False},
                                         '_parent': {'type': 'document'},
                                         'properties': {'estnltk_text_object': {'index': 'no',
                                                                                'store': True,
                                                                                'type': 'string'},
                                                        'lemmas': {'analyzer': 'estnltk_lowercase',
                                                                   'norms': {'enabled': False},
                                                                   'type': 'string'},
                                                        'meta': {'properties': {'order_in_parent': {'doc_values': True,
                                                                                                    'norms': {
                                                                                                        'enabled': False},
                                                                                                    'type': 'long'}}},
                                                        'postags': {'analyzer': 'estnltk_uppercase',
                                                                    'norms': {'enabled': False},
                                                                    'type': 'string'},
                                                        'text': {'analyzer': 'whitespace',
                                                                 'norms': {'enabled': False},
                                                                 'type': 'string'},
                                                        'words': {'properties': {'analysis':
                                                            {'properties':
                                                                {'clitic': {
                                                                    'doc_values': True,
                                                                    'index': 'not_analyzed',
                                                                    ...
                                                                    'ending': {
                                                                        ...
                                                                        'norms': {
                                                                            'enabled': False},
                                                                        'type': 'string'},
                                                                    'form': {'doc_values': True,
                                                                             'index': 'not_analyzed',
                                                                             'norms': {
                                                                                 'enabled': False},
                                                                             'type': 'string'},
                                                                    'lemma': {'doc_values': True,
                                                                              'index': 'not_analyzed',
                                                                              'norms': {
                                                                                  'enabled': False},
                                                                              'type': 'string'},
                                                                    ...
                                                                    'root_tokens': {
                                                                        ...
                                                                        'type': 'string'}},
                                                                'type': 'nested'},
                                                            'text': {'doc_values': True,
                                                                     'index': 'not_analyzed',
                                                                     'norms': {'enabled': False},
                                                                     'type': 'string'}}}}}},
               'settings': {'analysis': {'analyzer': {'estnltk_lowercase': {'filter': ['lowercase'],
                                                                            'tokenizer': 'whitespace',
                                                                            'type': 'custom'},
                                                      'estnltk_uppercase': {'filter': ['uppercase'],
                                                                            'tokenizer': 'whitespace',
                                                                            'type': 'custom'}}}}}
