...
def test_detect_clause_errors_with_syntax__static():
...
@pytest.mark.skipif(not os.path.exists(detect_clause_errors_input_file),
                    reason="missing input file {!r}".format(detect_clause_errors_input_file))
def test_fix_clause_errors_with_syntax__static():
    # Test that potential clause errors can be fixed with syntax in the test corpus
    # Note: this test works on static/pre-annotated input data
    clauses_layer   = 'v169_clauses'
    sentences_layer = 'v166_sentences'
    syntax_layer    = 'v168_stanza_syntax'
...
@pytest.mark.skipif(not os.path.exists(detect_clause_errors_input_file),
                    reason="missing input file {!r}".format(detect_clause_errors_input_file))
def test_fix_clause_errors_with_syntax_multisentence__static():
    # Test that potential clause errors can be fixed with syntax in a multisentence text object
    # Note: this test works on static/pre-annotated input data
    clauses_layer   = 'v169_clauses'
    sentences_layer = 'v166_sentences'
    syntax_layer    = 'v168_stanza_syntax'
