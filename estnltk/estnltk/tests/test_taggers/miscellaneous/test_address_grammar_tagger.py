...
def test_tagger():
    ...
    input_file = abs_path('tests/test_taggers/miscellaneous/address_grammar_tagger_input.json')
    target_file = abs_path('tests/test_taggers/miscellaneous/address_grammar_tagger_target.json')
