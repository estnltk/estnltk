...
def test_tagger():
    ...
    input_file = abs_path('tests/test_taggers/system_taggers/gap_tagger_input.json')
    target_file = abs_path('tests/test_taggers/system_taggers/gap_tagger_target.json')
