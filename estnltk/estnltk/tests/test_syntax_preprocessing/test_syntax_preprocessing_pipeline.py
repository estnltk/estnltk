...
if __name__ == '__main__':
    ...
    with open(abs_path('../../koondkorpus-experiments/temp/tokens_syntax_preprocessing_369f7c25.json')) as cg3_in, \
         ...
         open(abs_path('tests/test_syntax_preprocessing/analysed_tokens.txt'), 'w') as analyses_out, \
         open(abs_path('tests/test_syntax_preprocessing/expected_cg3.txt'), 'w') as cg3_out:
