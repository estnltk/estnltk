"""
Module enables to store and search `Text` objects in sqlite and Postgres databases.

For Postgres usage examples, see tutorial `estnltk/tutorials/storing_text_objects_in_postgres.ipynb`
"""
