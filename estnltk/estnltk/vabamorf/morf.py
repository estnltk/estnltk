...
from estnltk.vabamorf.helper_methods import regex_from_markers
from estnltk.vabamorf.helper_methods import get_vm_lexicon_paths
from estnltk.vabamorf.helper_methods import get_vm_lexicon_files

# path listings
PACKAGE_PATH = os.path.dirname(__file__)
DICT_ROOT_PATH = os.path.join(PACKAGE_PATH, 'dct')
# All Vabamorf's lexicons available in EstNLTK
VM_LEXICONS = get_vm_lexicon_paths(DICT_ROOT_PATH)
...
phonetic_marker_repetition_regex = re.compile('^('+('|'.join([re.escape(c) for c in phonetic_markers]))+')+$')
