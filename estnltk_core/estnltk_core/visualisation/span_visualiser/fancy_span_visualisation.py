...
from estnltk_core.visualisation.span_visualiser.plain_span_visualiser import PlainSpanVisualiser
from estnltk_core.visualisation.core.span_decomposition import decompose_to_elementary_spans
from estnltk_core.common import core_abs_path
...
class DisplaySpans:
    ...
    js_file = core_abs_path("visualisation/span_visualiser/span_visualiser.js")
    css_file = core_abs_path("visualisation/span_visualiser/prettyprinter.css")
    _text_id = 0
