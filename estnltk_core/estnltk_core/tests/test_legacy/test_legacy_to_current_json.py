...
def test_legacy_to_current_json():
    ...
    legacy_test_input  = os.path.join(CORE_PACKAGE_PATH, 'tests', 'test_legacy', 'legacy_test_input.json')
    legacy_test_output = os.path.join(CORE_PACKAGE_PATH, 'tests', 'test_legacy', 'legacy_test_output.json')
