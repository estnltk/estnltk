...
static  FSxC1 _pahad_tyved2_[] =  // ei sobi oletamisel nimis�na viimaseks komponendiks 
    {
        ...
        {FSxSTR("aasia")},  {FSxSTR("akti")},  {FSxSTR("aktiivne")}, {FSxSTR("aktiivse")},
        {FSxSTR("alane")},  {FSxSTR("alas")},  {FSxSTR("alase")}, {FSxSTR("alasi")}, 
        {FSxSTR("ambur")},  {FSxSTR("amburi")}, 
        {FSxSTR("andi")}, 
        {FSxSTR("anna")},   {FSxSTR("anni")},  {FSxSTR("asse")},  {FSxSTR("assi")},  {FSxSTR("aste")}, 
        {FSxSTR("astel")},  {FSxSTR("atika")}, {FSxSTR("augu")},  {FSxSTR("aval")},  
        {FSxSTR("bell")},   {FSxSTR("biidi")},
        {FSxSTR("biit")},   {FSxSTR("biiti")}, {FSxSTR("bool")}, 
        {FSxSTR("booli")},  {FSxSTR("boon")},  {FSxSTR("booni")}, {FSxSTR("boor")},  {FSxSTR("boori")}, 
        {FSxSTR("emis")},   {FSxSTR("emise")}, 
        {FSxSTR("ende")},   {FSxSTR("enne")},  
        {FSxSTR("foon")},   {FSxSTR("foone")}, {FSxSTR("fooni")},
        {FSxSTR("foor")},   {FSxSTR("foore")}, {FSxSTR("foori")},
        {FSxSTR("haha")},   {FSxSTR("hahk")},  {FSxSTR("hahka")}, {FSxSTR("hein")}, 
        {FSxSTR("iidi")},   {FSxSTR("iili")},  {FSxSTR("iive")},  {FSxSTR("ikoon")}, {FSxSTR("ikooni")},
        ...
        {FSxSTR("irvik")},  {FSxSTR("irviku")}, {FSxSTR("istik")},  {FSxSTR("istiku")},
        ...
        {FSxSTR("kikas")},  {FSxSTR("kikka")},
        {FSxSTR("kilt")},   {FSxSTR("kilda")}, {FSxSTR("kildi")}, {FSxSTR("kilti")},
        {FSxSTR("kiti")},   {FSxSTR("konn")},  {FSxSTR("konna")}, 
        {FSxSTR("kula")},   {FSxSTR("kuline")}, {FSxSTR("kulis")}, {FSxSTR("kulise")},  
        {FSxSTR("kult")},   {FSxSTR("kuldi")}, {FSxSTR("kulte")},  {FSxSTR("kulti")},
        {FSxSTR("kolla")},  {FSxSTR("kold")},  {FSxSTR("kolda")}, 
        {FSxSTR("laad")}, 
        ...
        {FSxSTR("lanti")},  {FSxSTR("lase")},  {FSxSTR("lasi")},  {FSxSTR("lass")},  
        {FSxSTR("last")},   {FSxSTR("lasti")},  
        {FSxSTR("lest")},   {FSxSTR("lesti")},  
        {FSxSTR("leen")},   {FSxSTR("leeni")}, {FSxSTR("leer")},  {FSxSTR("leeri")}, 
        {FSxSTR("lett")},   {FSxSTR("lette")},  {FSxSTR("leti")},
        {FSxSTR("liin")},   {FSxSTR("liine")},  {FSxSTR("liini")},
        ...
        {FSxSTR("loid")}, 
        {FSxSTR("loiu")}, 
        {FSxSTR("loos")},   {FSxSTR("loose")},  {FSxSTR("loosi")},
        {FSxSTR("loti")},  {FSxSTR("lott")},  {FSxSTR("lotti")}, {FSxSTR("male")},  
        {FSxSTR("l\374\374s")},   {FSxSTR("l\374\374se")},  {FSxSTR("l\374\374si")},  //lyys
        {FSxSTR("mann")},   {FSxSTR("manni")}, {FSxSTR("mant")},  {FSxSTR("mandi")}, {FSxSTR("manti")}, 
        {FSxSTR("mari")},   {FSxSTR("mast")},  {FSxSTR("mate")},  {FSxSTR("meka")},
        {FSxSTR("meer")},   {FSxSTR("meere")}, {FSxSTR("meeri")},
        {FSxSTR("mest")},   {FSxSTR("miin")},  {FSxSTR("miini")}, {FSxSTR("mink")},  {FSxSTR("minki")},
        {FSxSTR("mingi")}, 
        {FSxSTR("mool")},   {FSxSTR("moole")},  {FSxSTR("mooli")},
        {FSxSTR("naadi")}, {FSxSTR("naat")},  {FSxSTR("nata")},
        {FSxSTR("naati")},  {FSxSTR("nati")},  {FSxSTR("natsioon")},{FSxSTR("natsiooni")},
        {FSxSTR("natt")},   {FSxSTR("neer")},   {FSxSTR("neeru")}, {FSxSTR("neid")},  {FSxSTR("nina")}, 
        {FSxSTR("niidi")},  {FSxSTR("niin")},  {FSxSTR("niini")}, {FSxSTR("niine")}, {FSxSTR("niit")}, 
        {FSxSTR("niiti")},  {FSxSTR("noova")},
        {FSxSTR("nool")},   {FSxSTR("noole")},  {FSxSTR("nooli")},
        {FSxSTR("n\x00E4\x00E4r")}, {FSxSTR("n\x00E4\x00E4ri")},
        {FSxSTR("okas")},   {FSxSTR("okse")},  
        {FSxSTR("oomi")},
        {FSxSTR("orine")},  {FSxSTR("orise")}, {FSxSTR("oris")},
        {FSxSTR("ossa")},   {FSxSTR("paal")},  {FSxSTR("paali")}, 
        {FSxSTR("paadi")},  {FSxSTR("paat")},   {FSxSTR("paate")},  {FSxSTR("paati")},
        {FSxSTR("pett")},   {FSxSTR("pette")},  {FSxSTR("peti")},   {FSxSTR("petti")},
        {FSxSTR("ping")},  {FSxSTR("pingi")},  
        {FSxSTR("pood")},   {FSxSTR("poodi")}, {FSxSTR("poe")},
        {FSxSTR("poni")},   {FSxSTR("pordi")}, {FSxSTR("port")},  {FSxSTR("porti")}, {FSxSTR("raad")},  
        {FSxSTR("raadi")},  {FSxSTR("raal")},  {FSxSTR("raali")}, {FSxSTR("raats")}, {FSxSTR("raas")},
        {FSxSTR("randi")},  {FSxSTR("rant")},  {FSxSTR("ranti")}, {FSxSTR("ratsioon")}, {FSxSTR("ratsiooni")},
        {FSxSTR("reid")}, 
        {FSxSTR("rida")},   {FSxSTR("riid")},  {FSxSTR("riigi")}, {FSxSTR("riit")}, 
        {FSxSTR("riim")},   {FSxSTR("riime")},  {FSxSTR("riimi")},
        {FSxSTR("riiu")},   {FSxSTR("ring")}, 
        {FSxSTR("ringi")},  {FSxSTR("rist")},  {FSxSTR("risti")}, {FSxSTR("roid")},  {FSxSTR("rool")}, {FSxSTR("rooli")},
        {FSxSTR("roos")},   {FSxSTR("roose")},  {FSxSTR("roosi")},
        {FSxSTR("saad")},
        {FSxSTR("saan")},   {FSxSTR("saani")},
        {FSxSTR("sahvt")}, 
        {FSxSTR("saki")},   {FSxSTR("sakk")},  {FSxSTR("sakki")}, {FSxSTR("sandi")},
        {FSxSTR("sala")},   {FSxSTR("sant")}, 
        {FSxSTR("sante")},  {FSxSTR("santi")},
        {FSxSTR("sants")},   {FSxSTR("santse")},  {FSxSTR("santsu")},
        {FSxSTR("sasi")},  {FSxSTR("seen")},  {FSxSTR("seene")},
        ...
        {FSxSTR("sula")},   {FSxSTR("sule")}, 
        {FSxSTR("sool")},   {FSxSTR("soola")}, {FSxSTR("soole")},  {FSxSTR("sooli")},
        {FSxSTR("taani")},
        {FSxSTR("taadi")},  {FSxSTR("taat")},   {FSxSTR("taate")},  {FSxSTR("taati")},
        ...
        {FSxSTR("tiivik")}, {FSxSTR("tiiviku")},
        {FSxSTR("terts")},   {FSxSTR("tertse")},  {FSxSTR("tertsi")},
        {FSxSTR("tera")},   {FSxSTR("test")},  {FSxSTR("tikk")}, 
        {FSxSTR("tika")},   {FSxSTR("tikka")},  {FSxSTR("tiku")},
        {FSxSTR("ting")},   {FSxSTR("tingi")}, {FSxSTR("tingu")}, {FSxSTR("tite")},  {FSxSTR("toor")}, 
        {FSxSTR("toori")},  {FSxSTR("tori")},  {FSxSTR("torin")}, {FSxSTR("torina")}, 
        {FSxSTR("tool")},   {FSxSTR("toole")},  {FSxSTR("tooli")},
        {FSxSTR("toom")},   {FSxSTR("toome")},  {FSxSTR("toomi")},
        {FSxSTR("toos")},   {FSxSTR("toose")},  {FSxSTR("toosi")},
        {FSxSTR("tuur")},   {FSxSTR("tuuri")}, {FSxSTR("tust")},  {FSxSTR("tusti")}, 
        {FSxSTR("tuste")},  {FSxSTR("unna")},  {FSxSTR("ukse")}, 
        {FSxSTR("ustav")},  
        {FSxSTR("uriin")},   {FSxSTR("uriini")},  {FSxSTR("uriine")},
        ...
        {FSxSTR("vaks")},   
        {FSxSTR("viin")},   {FSxSTR("viini")},  
        {FSxSTR("viit")},  {FSxSTR("vile")},  {FSxSTR("vool")},  {FSxSTR("\x00E4ngi")}, {FSxSTR("\x00E4rtu")},
        {FSxSTR("\x00F6\x00F6r")}, {FSxSTR("\x00F6\x00F6ri")},  // o"o"r, o"o"ri
    };
