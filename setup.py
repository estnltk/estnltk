...
setup(
    ...
    package_data={
        ...
        'estnltk.taggers.syntax': ['files/*.*', 
                                   'files/LICENSE', 
                                   'maltparser_tagger/java-res/maltparser/*.*', 
                                   'maltparser_tagger/java-res/maltparser/lib/*.*', 
                                   'stanza_tagger/stanza_resources/*.*',
                                   'stanza_tagger/stanza_resources/et/lemma/*.*',
                                   'stanza_tagger/stanza_resources/et/pos/*.*',
                                   'stanza_tagger/stanza_resources/et/tokenize/*.*',
                                   'udpipe_tagger/resources/*.*',
