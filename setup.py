...
setup(
    ...
    package_data={
        ...
        'estnltk.taggers': ['standard_taggers/*.csv'],
        'estnltk.tests': ['test_morph/*.csv', 'test_corpus_processing/*.prevert', 'test_taggers/test_dict_taggers/*.csv', 'test_taggers/test_standard_taggers/*.json', ],
